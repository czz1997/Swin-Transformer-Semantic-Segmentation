...
export CONFIG_FILE="configs/swin_vanilla/upernet_swin_${BACKBONE}_patch4_window7_512x512_80k_$EXP_NAME.py"
export PRETRAINED_MODEL_PATH="weights/swin_${BACKBONE}_patch4_window7_224.pth"
export WORK_DIR="runs/${EXP_NAME}_swinTF_${BACKBONE}_vanilla"
export NUM_GPUS=4

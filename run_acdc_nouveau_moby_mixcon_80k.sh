...
# only tiny backbone pretrained weight is available
export PRETRAINED_MODEL_PATH="weights/moby_swin_t_300ep_pretrained.pth"

export WORK_DIR="runs/${EXP_NAME}_swinTF_${BACKBONE}_moby_mixcon"
export NUM_GPUS=4
